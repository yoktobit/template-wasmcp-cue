...
make build  # Output: target/wasm32-wasip2/release/mcp_test.wasm
```

## Compose

```bash
wasmcp compose server target/wasm32-wasip2/release/mcp_test.wasm -o server.wasm
```
...
# Stdio
wasmcp compose server target/wasm32-wasip2/release/mcp_test.wasm -t stdio -o server.wasm
